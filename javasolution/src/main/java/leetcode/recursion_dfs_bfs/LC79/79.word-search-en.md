...
as below pic:
```
![word search 1](../../../../resources/img/79.word-search-en-1.png)
...
2. Up（0，3）letter='E', match, continue DFS
3. Down（2，3）letter='E'，match, 
   - wait for #2（0，3) return result
   - if matching，terminate, return，
   - if #2 not match word，continue（2，3）DFS 
