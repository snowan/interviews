 ...
 * Example 1:
 *
 * Input: s = "main.java.leetcode", wordDict = ["leet", "code"]
 * Output: true
 * Explanation: Return true because "main.java.leetcode" can be segmented as "leet code".
 * Example 2:
 *
...
public class LC139WordBreak {
  ...
  public static void main(String[] args) {
    LC139WordBreak.wordBreak2("main/java/leetcode", Arrays.asList("leet", "code"));
  }
}
